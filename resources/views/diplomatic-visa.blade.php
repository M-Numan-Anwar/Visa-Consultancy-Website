...
@section('content')
     ...
     <!-- breadcrumb -->
        <div class="site-breadcrumb" style="background: url(assets/img/about/breadcrumb.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Diplomatic Visa</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="{{ route('home') }}"><i class="fa-solid fa-house"></i> Home</a></li>
                    <li class="active">Diplomatic Visa</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="service-details">
                                <div class="service-details-img mb-30">
                                    <img src="assets/img/visa/family-visa.jpg" alt="thumb">
                                </div>
                                <div class="service-details">
                                    <h3 class="mb-30">Diplomatic Visa</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="my-4">
                                        <div class="mb-3">
                                            <h3 class="mb-3">Diplomatic Visa Benefits</h3>
                                    ...
                                    <div class="my-4">
                                        <h3 class="mb-3">Why Choose Our Diplomatic Visa  ?</h3>
