...
@section('content')
   ...
   <!-- breadcrumb -->
        <div class="site-breadcrumb" style="background: url(assets/img/about/breadcrumb.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Canada</h2>
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="service-details">
                                <div class="service-details-img mb-30">
                                    <img src="assets/img/country/08.jpg" alt="thumb">
                                </div>
                                <div class="service-details">
                                    <h3 class="mb-30">Canada</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="my-4">
                                        <div class="mb-3">
                                            <h3 class="mb-3">Canada Benefits</h3>
                                    ...
                                    <div class="my-4">
                                        <h3 class="mb-3">Why Choose Canada ?</h3>
