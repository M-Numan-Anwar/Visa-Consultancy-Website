...
@section('content')
      ...
      <!-- breadcrumb -->
        <div class="site-breadcrumb" style="background: url(assets/img/about/breadcrumb.jpg)">
            <div class="container">
                <h2 class="breadcrumb-title">Consular Closings</h2>
                <ul class="breadcrumb-menu">
                    <li><a href="{{ route('home') }}"><i class="fa-solid fa-house"></i> Home</a></li>
                    <li class="active">Consular Closings</li>
                </ul>
            </div>
        </div>
        <!-- breadcrumb end -->
                        ...
                        <div class="col-xl-8 col-lg-8">
                            <div class="service-details">
                                <div class="service-details-img mb-30">
                                    <img src="assets/img/visa/consular-closings.jpg" alt="thumb">
                                </div>
                                <div class="service-details">
                                    <h3 class="mb-30">Consular Closings Visa</h3>
                                    <p class="mb-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            <div class="service-single-item">
                                                ...
                                                <h6>Fill In The Required Form</h6>
                                        ...
                                        <div class="col-md-4">
                                            <div class="service-single-item">
                                                ...
                                                <h6>Submit Your Original Documents</h6>
                                                <p>There are many variations of passages available but the majority suffered.</p>
                                            </div>
                                        </div>
                                        <div class="col-md-4">
                                            <div class="service-single-item">
                                                ...
                                                <h6>Get The Visa Resource Material</h6>
                                                <p>There are many variations of passages available but the majority suffered.</p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="my-4">
                                        <div class="mb-3">
                                            <h3 class="mb-3">Consular Closings Visa Benefits</h3>
                                    ...
                                    <div class="my-4">
                                        <h3 class="mb-3">Why Choose Our Consular Closings Visa  ?</h3>
